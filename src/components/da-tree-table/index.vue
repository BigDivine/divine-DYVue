...
<template>
  <div class="DaTreeTable">
    <div
      v-if="mode !== 2 && showPageHeader"
      class="pageHeader">
      <div
        v-if="mode !== 2 && showPageTitle"
        class="pageHeaderTitleContain">
        <div class="pageHeaderTitle">{{ pageTitle }}</div>
      </div>
      <div
        v-if="mode !== 2 && showPageTool && !readOnly && !isCustomTool"
    ...
    <Split
      ...
      <div
        ...
        <YSearchTree
          ...
          @node-delete="treeNodeDel"></YSearchTree>
      </div>
      <div
        slot="right"
        class="splitRight">
        <YSearchTable
          ...
          @page-num-change="pageNumChange"></YSearchTable>
      </div>
    </Split>
    <div
      v-else
